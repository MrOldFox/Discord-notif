...
class Greetings(commands.Cog):
    ...
    async def join(self, ctx):
        ...
        Присваивает роль "Участник турнира Dota 2". Также отправляет уведомление в Telegram о новом участнике.
        ...
        try:
            ...
            # Присваиваем пользователю роль "Участник турнира Dota 2"
            role = discord.utils.get(ctx.guild.roles, name="Участник турнира Dota 2")  # Находим роль по имени
            if role:
                await member.add_roles(role)  # Присваиваем найденную роль участнику
                self.logger.info(f'Пользователю {member.name} присвоена роль "{role.name}".')
                await ctx.send(f'Вам была присвоена роль "{role.name}"!')
